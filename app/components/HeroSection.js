      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="flex flex-col gap-8">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-bold uppercase tracking-wider w-fit">
            ...
            Gestión de Estilo de Próxima Generación
          </div>
          <h1 className="text-slate-900 dark:text-white text-5xl md:text-7xl font-extrabold leading-[1.1] tracking-tight">
            El Sistema Operativo para <span className="text-primary">Marcas</span> del Sector
            Estilo
          </h1>
          <p className="text-slate-600 dark:text-slate-400 text-lg md:text-xl leading-relaxed max-w-xl">
            Domina tu crecimiento con analíticas de alta fidelidad, retención automatizada e
            inteligencia de inventario. Diseñado para equipos que no quieren improvisar.
          </p>
        ...
        <div className="relative group">
          <div className="absolute -inset-4 bg-gradient-to-tr from-primary/20 to-accent-growth/15 rounded-[2rem] blur-2xl group-hover:opacity-75 transition-opacity"></div>
          <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/20">
            <div className="bg-slate-900 p-4 flex items-center gap-2">
              ...
              <div className="mx-auto text-[10px] text-slate-500 font-mono uppercase tracking-widest">
                StyleFlow - Panel Multi-Sucursal
              </div>
            </div>
            <Image
              alt="Dashboard de StyleFlow"
